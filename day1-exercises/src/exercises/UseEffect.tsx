...
export default function UseEffectDemo({ title }: BaseProps) {
  ...
  useEffect(() => { 
    ...
    const i = setInterval(() => { setCount((prev) => prev + 1);
    }, 100);
  ...
  useEffect(() =>{
    ...
    //cleanup function
  },[]) //Use a dependency array... What is a dependency array? What is the purpose of the dependency array?
  // ahh, if the value in the dependency array changes, the effect function is called again.
